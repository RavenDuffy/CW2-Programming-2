...
/** The Undergrad class is used to represent undergraduate students at the university.
 *  <p>It extends Students so that it can inherit the methods created in Student and
 *  defined in Students.</p>
 *  <p>This class has two separate constructors: one to create a new Undergrad
 *  object using just the student's name, their birthdate and a list of modules 
 *  (this is the constructor the user sees) and one to create a new Undergrad object
...
public class Undergrad extends Students{
	 ...
	 */
	public Undergrad(String name, String birthDate, ArrayList<Module> modules) throws FileNotFoundException {
	 ...
	 *  be used to recreate Undergrad objects based on the text files: 
	 ...
	 *  @throws FileNotFoundException
	 */
	public Undergrad(String birthDate, String studentID, SmartCard smartCard, ArrayList<Module> modules) throws FileNotFoundException {
